...
class TestUserService(BaseTestCase):
    ...
    def test_add_user(self):
        ...
        with self.client:
            ...
            self.assertIn('michael@gmail.com was added!', data['message'])
            self.assertIn('success', data['status'])
    ...
    def test_all_users(self):
        ...
        add_user('fletcher', 'fletcher@gmail.com')
        with self.client:
            ...
            self.assertIn(
                'michael@gmail.com', data['data']['users'][0]['email'])
            self.assertIn('fletcher', data['data']['users'][1]['username'])
            self.assertIn(
                'fletcher@gmail.com', data['data']['users'][1]['email'])
            self.assertIn('success', data['status'])
